  ...
  const handleContactClick = () => {
    if (window.dataLayer) {
      window.dataLayer.push({
        ...
        button_name: "Contact Me Here",
        page_section: "Contact Section"
      });
      console.log("✅ Event sent to GTM: contact_button_click");
    }
    ...
    >
      ...
      <div className="w-full max-w-4xl flex flex-col lg:flex-row items-center lg:items-start gap-6 sm:gap-8 lg:gap-10">
        <div className="flex-1 flex flex-col justify-center order-2 lg:order-1 w-full">
          ...
          <p className="text-indigo-200 mb-3 sm:mb-4 text-sm sm:text-base text-center lg:text-left">
            I'm open to internship opportunities, junior developer roles, project
            collaborations, or a quick hello. Feel free to reach out!
          </p>
          ...
          <div className="space-y-1.5 sm:space-y-2 text-indigo-100 mb-4 sm:mb-5">
            ...
            <div className="text-center lg:text-left">
              <span className="font-semibold text-fuchsia-300 text-sm sm:text-base">Phone:</span>{" "}
              <a
            ...
            <div className="text-center lg:text-left">
              <span className="font-semibold text-fuchsia-300 text-sm sm:text-base">Location:</span>{" "}
      ...
      <div className="mt-6 sm:mt-8 text-center lg:hidden">
        <p className="text-indigo-200 text-xs sm:text-sm">
          Tap the image or button to contact me directly
        </p>
      </div>
    </div>
  );
